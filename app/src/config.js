...
const config = {
  ...
  custom_placeholder: _('Enter template url...'),
  custom_description: _('Enter a tile URL template. Valid tokens are {z}, {x}, {y}, for Z/X/Y scheme and {u} for quadtile scheme.'),
